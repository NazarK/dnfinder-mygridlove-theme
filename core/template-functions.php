...
if ( !function_exists( 'gridlove_get_social_share' ) ):
	function gridlove_get_social_share() {
		...
		$share['vk'] = '<a href="javascript:void(0);"  class="gridlove-vKontakte gridlove-share-item" data-url="http://vk.com/share.php?url='.urlencode( esc_url( get_permalink() ) ).'&amp;title='.urlencode( esc_attr( get_the_title() ) ).'"><i class="fa fa-vk"></i></a>';
		$share['whatsapp'] = '<a href="whatsapp://send?text='.urlencode( esc_url( get_permalink() ) ).'" class="gridlove-whatsapp"><i class="fa fa-whatsapp"></i></a>';
