...
Redux::setSection( $opt_name , array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'default' =>  __( '<p style="text-align: center;">Copyright &copy; Created by <a href="http://mekshq.com" target="_blank">Meks</a>. Powered by <a href="http://www.wordpress.org" target="_blank">WordPress</a></p>', 'gridlove' ),
                'args'   => array(
                    'textarea_rows'    => 3  ,
                    'default_editor' => 'html'                          ),
            ...
            array(
             ...
             array(
                ...
                'options'   => array(
                    ...
                    'vk' => esc_html__( 'vKontakte', 'gridlove' ),
                    'whatsapp' => esc_html__( 'WhatsApp', 'gridlove' ),
...
Redux::setSection( $opt_name , array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'options'   => array(
                        'none' => esc_html__( 'None', 'gridlove' ),
                        'yoast' => esc_html__( 'Yoast SEO (or Yoast Breadcrumbs)', 'gridlove' ),
                        'bcn' => esc_html__( 'Breadcrumb NavXT', 'gridlove' ),
                    ),
                'default'   => 'none',
            ),
